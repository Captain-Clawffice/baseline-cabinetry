...
export const POST: RequestHandler = async ({ request }) => {
	const { name, email, phone, message, projectType, timeline } = await request.json();
...
<table style="border-collapse:collapse;font-family:sans-serif">
  ...
  <tr><td style="padding:4px 12px 4px 0;font-weight:bold">Timeline:</td><td>${timeline ?? 'Not specified'}</td></tr>
</table>
<h3>Message:</h3>
